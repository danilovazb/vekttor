...
<span></span>    Clientes X Serviços X Tempo 
</a>
</div>
<div id="barra_info">
<?php
	...
	echo "<strong>Serviço:</strong>" .$servico->nome;
?>
...
<td>
	<?php
		if(!$ultima_vez_executado_cliente>0){
			echo "Nunca Executou este serviço";
		}else{
			echo "Executou há $ultima_vez_executado_cliente->diferenca dias";
		}
	?>
</td>
</tr>
