...
<table cellpadding="0" cellspacing="0" width="100%">
    ...
    $registros= mysql_result(mysql_query("SELECT count(*) FROM odontologo_convenio WHERE vkt_id='$vkt_id' $busca_add"),0,0);
	...
	?>
<tr <?=$sel?>onclick="window.open('<?=$caminho?>/form.php?cf_id=<?=$r->cf_id?>','carregador')">
