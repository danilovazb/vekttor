...
<div id="atestado">
    ...
    <div id="titulo_atestado">
        ...
        1&ordf; via: paciente - 2&ordf; via: consultório
    	</div>
    </div>
    <div id="texto_atestado">
        ...
        <div class="trecho_texto">, residente e domiciliado(a) à</div>
        ...
        <div class="trecho_texto" style="word-spacing:3px;">esteve sob tratamento odontológico neste consultório, no período</div>
        <div class="trecho_texto">das</div>
                
        <div class="linha atestado_hora"> <?=substr($atestado->hora_inicio,0,5)?></div>
        <div class="trecho_texto" style="margin-left:5px;"> às </div>
    ...
    <div style="clear:both"></div>
     ...
     <div id="autorizacao_paciente" style="float:left;width:250px;padding: 0 0 0 30px;">
        ...
        autorização do seu paciente ou de seu representante legal
    	</div>
    </div>
