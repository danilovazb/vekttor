...
$q=mysql_query($trace="SELECT * FROM eleitoral_eleitores WHERE vkt_id ='$vkt_id' AND (nome  like '%$_GET[busca_auto_complete]%')  LIMIT 15");
//echo $trace;
$i=0;
...
if($i==0){
	echo urlencode("Não Encontrado, Cadastre em Eleitores|0|0\n");
}
?> 