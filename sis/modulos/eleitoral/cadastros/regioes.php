...
<div id="barra_info">
    <a href="<?=$caminho?>/form_regiao.php" target="carregador" class="mais"></a>
</div>
...
<table cellpadding="0" cellspacing="0" width="100%">
	...
	?>
     <tr class="aplicavel" onclick="window.open('<?=$caminho?>/form_regiao.php?idregiao=<?=$regiao->id?>','carregador')">
            <td width="100"><?=$regiao->id?></td>
