...
<div style="margin:3px 5px;"> Total Enviado: <b><?php echo $total;?></b> </div>
<table cellpadding="0" cellspacing="0" width="100%" >
<thead>
    	<tr>
          <td width="300">Mensagem Enviada</td>
          <td width="120">Eleitor Enviado</td>
          <td width="120" style="border-right:3px solid #CCC;">Nao Enviado</td>
          <td width="120">Politico Enviado</td>
          <td width="120" style="border-right:3px solid #CCC;">Nao Enviado</td>
          <td width="120">Colaborador Enviado</td>
...
<table cellpadding="0" cellspacing="0" width="100%" id="tabela_dados" >
    <tbody>
    	...
    	<tr <?=$sel?> id="<?php echo $r->id?>" title="<?php echo $r->msg_enviada;?>">
          ...
          <td width="120" style="color:<?=$cor?>; font-weight:bold;">
		  	<?php echo $t_enviado_eleitor;?>
          </td>
          
          <td width="120" style="color:<?=$cor_naoenviado_eleitor?>; font-weight:bold; border-right:3px solid #CCC;">
          ...
          <td width="120" style="color:<?=$cor_naoenviado_politico?>; font-weight:bold; border-right:3px solid #CCC;">
          ...
          <td width="120" style="color:<?=$cor?>; font-weight:bold;">
           ...
           <td width="120" style="color:<?=$cor_naoenviado_coladorador?>; font-weight:bold;">
