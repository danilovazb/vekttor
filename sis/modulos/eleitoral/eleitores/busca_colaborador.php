...
$q=mysql_query($trace="SELECT c.id as id,c.nome as nome,f.nome as funcao FROM eleitoral_colaboradores as c,eleitoral_funcoes as f WHERE (c.nome  like '%$_GET[busca_auto_complete]%') AND c.vkt_id ='$vkt_id' AND c.funcao_id=f.id LIMIT 15");
//echo $trace;
$i=0;
