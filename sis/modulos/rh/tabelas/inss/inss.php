    ...
    <thead>
    	<tr>
             <td width="80">Valor Mínimo</td>
          	...
          	<td width="100">Valor Benefício</td>
          	<td></td>
        </tr>
    </thead>
</table>
...
<table cellpadding="0" cellspacing="0" width="100%">
	...
	$q= mysql_query($t="SELECT * FROM 
		rh_inss ".$_GET['ordem_tipo']." LIMIT ".paginacao_limite($registros,$_GET[pagina],$_GET[limitador]));
	//echo $t;
	...
	?>
<tr <?=$sel?> onclick="window.open('modulos/rh/tabelas/inss/form.php?id=<?=$r->id?>','carregador')">
