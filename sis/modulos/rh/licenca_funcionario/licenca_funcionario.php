...
<div id="barra_info">    
	<a href="modulos/rh/licenca_funcionario/form.php" target="carregador" class="mais"></a>
...
<table cellpadding="0" cellspacing="0" width="100%">
	...
	?>
<tr <?=$sel?> onclick="window.open('modulos/rh/licenca_funcionario/form.php?id=<?=$r->id?>','carregador')">
 <td width="230"><?=$funcionario->nome?></td>
