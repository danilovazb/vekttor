...
<body>
<div style="color:#999; background:#FFF; width:226px; position:absolute; left: 591px; top: 13px; padding:10px;">
Instrução para Impres&atilde;o em Firefox<br />
<br />
<strong>Modelo 2</strong><br />
<br />
1- Arquivo&gt; Configurar P&aacute;gina&gt; M&aacute;rgems
<br />
2- Superior 0<br />
3- Esquerda <strong>8</strong><br />
4- Direita 0<br />
5 - Inferior 0
</div>
<table width="550" height="180" id='win_add_cont' border="0" cellspacing="0" cellpadding="0" >
  <form action="cd_mod2.php" method="post" id="form1">
    <tr  >
    ...
    <tr>
      ...
      <td height="150" valign="middle" bgcolor="#ECE9D8" style="padding:20px;" >Nome Empregado: 
        ...
        CEP:
        <input name="cep" type="text" id="cep" size="10" maxlength="9" ticle='12345 12' />
                 UF:
...
<input name="telefone" type="text" id="telefone" size="10" maxlength="8" />
                 Nascimento:
                 <input name="nascimento" type="text" id="nascimento" size="6" maxlength="8" />
        ...
        <input name="ctps" type="text" id="ctps" size="7" maxlength="7" />
                Numero Serie: 
                <input name="ctps_numero" type="text" id="ctps_numero" size="10" maxlength="3" />
        UF:
...
<input name="admissao" type="text" id="admissao" size="10" maxlength="6" />
&nbsp;Data de Dispensa
<input name="dispensa" type="text" id="dispensa" size="10" maxlength="6" />
<br />
<br />
Quantidade de Meses que Trabalhou
<input name="meses" type="text" id="meses" value="" size="1" maxlength="2" /> &nbsp;&nbsp;
Horas Trabalhadas por semana 
<input name="horas" type="text" id="horas" value="" size="1" maxlength="2" />
<br />
<hr />
<br />
M&ecirc;s 
<input name="mes2" type="text" id="mes2" value="" size="1" maxlength="2" /> 
Ante Penultimo Sal&aacute;rio 
<input name="salario2" type="text" id="salario2" value="" size="10" maxlength="10" />
<br />
<br />
M&ecirc;s
<input name="mes3" type="text" id="mes3" value="" size="1" maxlength="2" />
Penultimo Sal&aacute;rio
<input name="salario3" type="text" id="salario3" value="" size="10" maxlength="10" />
<br />
<br />
M&ecirc;s
<input name="mes4" type="text" id="mes4" value="" size="1" maxlength="2" />
Ulltimo Sal&aacute;rio
<input name="salario4" type="text" id="salario4" value="" size="10" maxlength="10" />
<br />
<br />
Soma dos 3 Ultimos S&aacute;larios 
<input name="soma" type="text" id="soma" value="" size="10" maxlength="10" />
<br />
<br />
...
<label><input name="modelo" type="radio" id="radio" value="1" checked="checked" />
	Modelo 1</label>
<label><input name="modelo" type="radio" id="radio2" value="2" checked="checked" />
Modelo 2</label>
<br />
        <br />	<input name="teste" type="checkbox" id="teste" value="1" /> Teste<br />
        <br />
