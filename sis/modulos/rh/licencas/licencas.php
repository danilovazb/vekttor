...
<div id="barra_info">
	...
	<a href="modulos/rh/licencas/form.php" target="carregador" class="mais"></a>
...
<table cellpadding="0" cellspacing="0" width="100%">
	...
	$q= mysql_query($t="
		...
		WHERE vkt_id='$vkt_id'
		$busca_add 
		ORDER BY nome ".$_GET['ordem_tipo']." LIMIT ".paginacao_limite($registros,$_GET[pagina],$_GET[limitador]));
	...
	?>
<tr <?=$sel?> onclick="window.open('modulos/rh/licencas/form.php?id=<?=$r->id?>','carregador')">
<td width="230"><?=$r->nome?></	td>
<td width="80"><?=$r->codigo?></td>
<td></td>
</tr>
<?
	}
