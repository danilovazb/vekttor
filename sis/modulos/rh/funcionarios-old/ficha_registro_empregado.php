...
<table border="0" cellpadding="0" cellspacing="0" id="tbl_registro_empregado">
  ...
  <tr>
    <td colspan="4" style="width:650px;text-align:center;"><strong>FICHA REGISTRO DE EMPREGADO</strong><div style="float:right;font-size:18px;width:10px;margin-right:25px;"><?=$empregado->numero_sequencial_empresa?></div></td>
    <td width="176" rowspan="4" align="center" style="width:150px;">FOTO</td>
  </tr>
  <tr>
    <td colspan="3" style="width:410px;"><div class="campo">Firma:</div><?=$cliente_fornecedor->razao_social?></td>
    <td width="133" style="width:100px;"><div class="campo">Atividade Comercial:</div><?=$empresa->ramo_atividade?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="width:100px;border-right:none;"><div class="campo">Nome do Empregado: </div><?=$empregado->nome?></td>
  ...
  <tr>
    <td colspan="2"><div class="campo">Salário:</div><?=MoedaUsaToBr($empregado->salario)?></td>
  ...
  <tr>
    ...
    <td>
    	<div class="campo" style="width:30px;float:left">Série:</div>
		<div class="campo" style="float:right">UF:</div>
        
        <div style="clear:both"></div>
        
		<?=$empregado->carteira_profissional_serie?>
        
        <div style="float:right"><?=$empregado->carteira_profissional_estado_emissor?></div>
  ...
  <tr>
    ...
    <td><div class="campo">Tipo Admissao:</div><?=$empregado->tipo_admissao?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td colspan="2"><div class="campo">Cor:</div><?=$empregado->cor?></td>
...
<tr>
   ...
   <tr>
    ...
    <td colspan="2"><div class="campo">Naturalidade:</div><?=$empregado->uf_nascimento?></td>
  ...
  <tr>
    <td colspan="2"><div class="campo">Residencia Atual:</div><?=$empregado->endereco?></td>
...
<table id="dados_dependentes">
    ...
    <tr>
        ...
        <td><?=$dependete->grau_parentesco?></td>
    </tr>
...
<div id="rodape">
  ...
  <!--<div style="margin-top:30px;float:right;margin-right:200px;">Assinatura Empregado:</div>-->
	...
	Data em que o empregado deixou o serviço desta firma:<?=DataUsaToBr($demissao->data_demissao)?>
