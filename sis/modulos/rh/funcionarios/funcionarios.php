...
<table cellpadding="0" cellspacing="0" width="100%">
	...
	?>
<tr <?=$sel?>onclick="location.href='?tela_id=420&empresa1id=<?=$r->cliente_fornecedor_id?>'">
<td width="50" align="right"><?=str_pad($r->cliente_fornecedor_id,5,"0",STR_PAD_LEFT)?></td>
<td width="350"><?=$r->razao_social?></td>
<td width="130"><?=$r->cnpj_cpf?></td>
<td width="90"><?
echo $qtd_func;
$total_funciononarios =$qtd_func+$total_funciononarios;
?></td>
<td></td>
</tr>
<?
...
<table cellpadding="0" cellspacing="0" width="100%">
    <thead>
    	<tr>
           <td width="50">&nbsp;</td>
           <td width="350"><a>Total: <?=$total?></a></td>
           <td width="130">&nbsp;</td>
           <td width="110"><?=$total_funciononarios?></td>
           <td width="80">&nbsp;</td>
		   <td width="110">&nbsp;</td>
           <td></td>
      </tr>
