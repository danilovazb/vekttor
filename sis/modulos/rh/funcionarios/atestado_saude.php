...
<table style="border-collapse:collapse;" width="100%">
    ...
    <tr>
     ...
     <tr>
       <td class="font-title" style="width:450px;"> Cargo Fun&ccedil;&atilde;o:
         <?=utf8_encode($empregado->cargo)?></td>
       <td class="font-title" style="width:180px;"> RG:
         <?=$empregado->rg?></td>
       <td class="font-title">&nbsp;</td>
     </tr>
     <tr>
    	<td colspan="3" class="font-title" style="width:450px;"> Empresa: <?=$cliente_fornecedor->razao_social?></td>
    </tr>
    <tr>
    	<td colspan="3"> 
            ...
            <div style="width:800px; margin:0 auto; margin-top:15px;" class="font-normal"> 
                ...
                <span style="padding-left:50px;"> <span class="borda-linha">x</span> Admissional</span> 
    	...
    	<td  colspan="3"> 
           ...
           <div class="font-normal" style="margin:0 auto; width:920px; margin-bottom:25px; margin-top:13px;">     
        		...
        		<div style="float:left; width:180px;" class="font-normal">
                	<span class="borda-linha">x</span> F&iacute;sico
...
<table style="border-collapse:collapse;" width="100%">
    ...
    <tr>
    	<td colspan="2">
        	<div class="font-normal" style="padding-left:12px; float:left; width:330px;">Ex. Par. Fezes <span class="borda-linha">x</span></div>
            <div class="font-normal" style="padding-left:12px; float:left;width:330px;">P. Baar no Escarro <span class="borda-linha">x</span></div>
            <div class="font-normal" style="padding-left:12px;">Urin&aacute;lise <span class="borda-linha">x</span></div>
        </td>
        <td></td>
    </tr>
     <tr>
    ...
    <tr>
     ...
     <tr>
    	<td colspan="2">
        	<div class="font-normal" style="padding-left:12px; float:left; width:330px;">E. C. G. <span class="borda-linha">x</span></div>
        </td>
        <td></td>
    </tr>
    <tr>
     ...
     <tr>
    	<td colspan="2">
        	<div class="font-normal" style="padding-left:12px; float:left; width:330px;">E. E. G. <span class="borda-linha">x</span></div>
        </td>
        <td></td>
    </tr>
     <tr>
    ...
    <tr>
    	<td colspan="2">
            ...
            <div class="font-normal" style="padding-left:12px; float:left;width:100px;"> <span class="borda-linha">x</span> Apto </div>
