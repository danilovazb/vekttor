       ...
       <label style="width:300px">
        ...
        <label style="width:110px;">
			...
			<select name="motivo" id="motivo">
        		<option value="1">BONIFICAÇÃO</option>
                <option value="2">GRATIFICAÇÃO POR FUNÇÃO</option>
        ...
        <div style="clear:both"></div>
         ...
         <label style="width:300px;">
        	observacao
		<textarea name="observacao" id="observacao" style="width:300px;"></textarea>
        </label>
       ...
       <?php
		...
		?>
            ...
            <td width="100"><?=DataUsaToBr($alteracao->data)?></td>
          	<td width="90" ><?=$salario_antigo?></td>
       	 	<td width="90" ><?=MoedaUsaToBr($alteracao->salario)?></td>       	
			<td width="150" rel="tip" title="<?=$motivos[$alteracao->motivo]?>"><?=$motivos[substr($alteracao->motivo,0,150)]?>...</td>
            <td width="150" rel="tip" title="<?=$alteracao->observacao?>"><?=substr($alteracao->observacao,0,150)?>...</td>
