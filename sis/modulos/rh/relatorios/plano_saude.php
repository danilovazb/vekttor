...
<table cellpadding="0" cellspacing="0" width="100%">
    <thead>
    	...
    	<tr>
            ...
            <td width="100">Vlr Funcionário</td>
...
<table cellpadding="0" cellspacing="0" width="100%">
	...
	$registros= mysql_result(mysql_query("SELECT 
					  ...
					  WHERE 
					  	f.vkt_id='$vkt_id' AND
						f.plano_saude_id = cf.id AND						
						f.status != 'demitidos'
						$filtro
						GROUP BY(plano_saude_id)"),0,0);
	$q = mysql_query($t="
					  SELECT 
					  	plano_saude_id,
						...
						(SELECT razao_social FROM cliente_fornecedor WHERE id=plano_saude_id) as plano_saude
	...
	?>       
    	<tr <?=$sel ?> onclick="location.href='?tela_id=575&plano_saude_id=<?=$r->plano_saude_id?>'">
