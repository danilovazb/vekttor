        ...
        <label style="width:32px;"><br/>
          ...
          <!-- modal -->
           <div style="position:absolute;  margin-top:51px; margin-left:298px;">
              <div class="modal" style="display:none" id="janela_cliente">
...
<div style="float:left; width:300px" id='centro_de_custos'>
   ...
   <div style="clear:both; display:block;">     
        ...
        <!--<label style="width:120px; display:none">    
			Centro de Custos
        ...
        <input type="hidden" name="centro_custo_id[]" id="centro_custo_id" value="<?=$rcp->plano_id?>">
        <?
		...
		?>
        <label style="width:280px; margin-right:0;">Centro de Custos
        	<input type="text" name="centro_custo" id="centro_custo" style="width:230px;" busca='modulos/financeiro/busca/busca_centro_custo.php,@r1,@r0-value>centro_custo_id|@r1-value>centro_custo,0' value="<?=$centro->nome?>">
            <div style="float:right;display:inline;"><button id="busca_centro_custo" type="button"> <img src="../fontes/img/lupa2.png" width="15" ></button></div>
        </label>
          <!-- modal plano de contas -->	
           <div style="position:absolute;margin-top:51px; margin-left:-80px;" >
              <div class="modal" style="display:none" id="janela_centro_custo">
              <div class="modal-header-2">
              	<a href="#" style="color:#CCC; font-weight:bold;float:right;" class="modal_close">x</a>
                <span>Centro de Custos</span>
              </div>
                    <div class="modal-body">
                    	<div><label><input type="text" name="busca_plano" id="busca_plano"></label></div>
                        <div style="clear:both;"></div>
                    	<div style="overflow:auto; max-height:200px;">
                        	<table style="border:0;" width="100%" class="table-dados" >
                              <tbody>
                              <?
 		...
 		<label style="width:80px;display:none;">
			Valor <input name="centro_valor[]" id="centro_valor" value="<?=moedaUsaToBr($rcp->valor) ?>"  onkeyup="calc_plano_centro_valor(this)"  >  
       </label>
  		<label style="width:30px; display:none;">
        %
         <input type="hidden" name="centro_porcentagem[]" id="centro_porcentagem" onkeyup="calc_plano_centro_porcentagem(this)" value="100"  >
       </label>
	...
	?>
		...
		<div style="float:left; width:300px; display:inline;margin-right: 0px;" id='plano_de_contas'>
        <?
	...
	?>
        ...
        <!--</label>-->
        <input type="hidden" name="plano_de_conta_id[]" id="plano_de_conta_id" value="<?=$rcp->plano_id?>">
        <?php
        	if(!empty($rcp->plano_id)){
				$plano = mysql_fetch_object(mysql_query(" SELECT * FROM financeiro_centro_custo WHERE id = '$rcp->plano_id' AND plano_ou_centro = 'plano' "));
			}
		?>
        <label style="width:290px;margin-right: 0px;">Plano de Conta
        <input type="text" name="plano_conta" id="plano_conta" style="width:240px;" busca='modulos/financeiro/busca/busca_plano_conta.php,@r1,@r0-value>plano_de_conta_id|@r1-value>plano_conta,0' autocomplete='off' value="<?=$plano->nome?>">
        <div style="float:right;display:inline;"><button id="busca_plano_conta" type="button"> <img src="../fontes/img/lupa2.png" width="15" ></button></div>
        </label> 
 		    <!-- modal plano de contas -->	
           <div style="position:absolute;margin-top:51px; margin-left:-80px;" >
              <div class="modal" style="display:none" id="janela_plano_contas">
              <div class="modal-header-2">
              	<a href="#" style="color:#CCC; font-weight:bold;float:right;" class="modal_close">x</a>
        ...
        <label style="width:80px; display:none;margin-right: 10px;">
			Valor
			  <input name="plano_valor[]" id="plano_valor" onkeyup="calc_plano_centro_valor(this)" value="<?=moedaUsaToBr($rcp->valor)?>" >
        </label>
  		<label style="width:30px; display:none">
        %
         <input type="hidden" name="plano_porcentagem[]" id="plano_porcentagem" onkeyup="calc_plano_centro_porcentagem(this)" value="100" >
       </label>
      	<!--<img src="../fontes/img/<?=$img?>.png" onclick="addPlc(this)" width="18" height="18" style=" margin-top:20px" />-->
			  ...
			  <select name="origem_tipo" id="origem_tipo">
			   ...
			   ?>
                ...
                <option value="Extorno" <?=$origem_tipo["Extorno"]?>>Extorno</option>
                  ...
                  <option value="venda" <?=$origem_tipo["venda"]?>>Venda</option>
              </select>
        </label>
