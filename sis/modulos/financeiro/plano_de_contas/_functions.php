...
function gerencia_centro_de_custo($ordem,$nome,$descricao,$centro_custo_id,$plano_ou_centro,$id,$acao,$visualiza_soma){
	if(isset($visualiza_soma)){$marcado='sim';}else{$marcado='nao';}
	$tabela = 'financeiro_centro_custo';
	$sql_meio= "SET cliente_id ='".$_SESSION[usuario]->cliente_vekttor_id ."',ordem='$ordem',centro_custo_id='$centro_custo_id',nome='$nome' ,plano_ou_centro='$plano_ou_centro', descricao='$descricao',exibir_soma='$marcado'";
