...
$q=mysql_query("SELECT * FROM cliente_fornecedor WHERE cliente_vekttor_id ='$cliente_id' $filtro_cliente AND (razao_social  like '%$_GET[busca_auto_complete]%' OR REPLACE(REPLACE(REPLACE(cnpj_cpf,'.','' ),'-',''),'/','') like '%$_GET[busca_auto_complete]%')  LIMIT 15");
$i=0;
