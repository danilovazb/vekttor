...
<div>
	...
	<fieldset  id='campos_1' >
		...
		<label style="width:144px; margin-right:23px;">
			D. Prevista:
			<input type="text" name="data_prevista" id="data_prevista" value="<?=dataUsaToBr($obj->data_prevista)?>" maxlength="23" calendario='1' sonumero='1' valida_data='1'  mascara='__/__/____' retorno='focus|Favor preencher o campo corretamente' />
		</label>
		<label style="width:144px; margin-right:23px;">
			D. de Início:
			<input name="data_inicio" id='data_inicio' type="text" value="<?=dataUsaToBr($obj->data_inicio)?>" maxlength="23" calendario='1' sonumero='1' valida_data='1'  mascara='__/__/____' retorno='focus|Favor preencher o campo corretamente' />
		</label><br />
		<label style="width:144px; margin-right:23px;">
			D. de Encerramento:
			<input name="data_fim" id='data_fim' type="text" value="<?=dataUsaToBr($obj->data_fim)?>" maxlength="23" calendario='1' sonumero='1' valida_data='1'  mascara='__/__/____' retorno='focus|Favor preencher o campo corretamente' valida_valor='1,2' />
		</label>
		<label style="width:144px; margin-right:23px;">
			Valor Total:
			<input name="valor_total" id='valor_total' type="text" value="<?=moedaUsaToBr($obj->valor_total)?>" maxlength="23" decimal="2" sonumero="1" style="text-align:right" valida_valor='0.01,999999999999999' retorno='focus|Favor preencher o campo corretamente' />
		</label><br />
		...
		<label style="width:144px; margin-right:23px;">
			Número da Nota:
			<input name="numero_nota" id='numero_nota' type="text" value="<?=$obj->numero_nota?>" sonumero="1" maxlength="50" style="text-align:right" valida_minlength='1' retorno='focus|O número da nota não pode estar vazio.' />
		</label>
	</fieldset>
	...
	<fieldset  id='campos_2' style="display:none" >
    	...
    	<div style="max-height:250px; width:370px; overflow:auto;">
			<?
			$x=mysql_query("SELECT *,c.id as id,p.id as produto_id FROM compra_has_produto as c, produto as p
			...
			<div class="linha_add">
				...
				<input name="produto_id[]" value="<?=$y->produto_id?>" type="hidden" />
				<label style="width:144px;">
					<?
					if($y->finalizar_produto_qtd!=NULL)$produto_qtd=$y->finalizar_produto_qtd;
					else $produto_qtd=$y->autorizar_produto_qtd;
					?>
...
<input name="action" type="submit"  value="Finalizar" style="float:right;margin-right:10px" onclick="confirmFinalizar(this)"  />
