	...
	<fieldset  id='campos_2' style="display:none" >
    	...
    	<div style="max-height:250px; width:370px; overflow:auto;">
			...
			<div class="linha_add">
				...
				<label style="width:144px;">
					<?
					if($y->efetivar_produto_qtd!=NULL)$produto_qtd=$y->efetivar_produto_qtd;
...
<input name="action" type="submit"  value="Efetivar" style="float:right;margin-right:10px" onclick="confirmEfetivar(this)"  />
