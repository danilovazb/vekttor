...
<a href="?tela_id=75" class="navegacao_ativo">
<span></span>   Efetivar Compras
</a>
</div>
<div id="barra_info">
    <form action="" method="get" style="float:left">
		...
		<label for="status">Exibir:</label>
			...
			<option <? if(($_GET['status']=="Autorizado"||$_GET['status']=="")&&$_GET['ordem']=="")echo "selected='selected'" ?> value="Autorizado">Autorizado</option>
...
<table cellpadding="0" cellspacing="0" width="100%">
	...
	elseif(!$_GET['ordem'])$status="Autorizado";
