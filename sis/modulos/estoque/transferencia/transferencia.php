...
$("a.mais").live("click",function(){
		...
		var id_destino = $("select#destino_id").val();
			...
			if(erro > 0){
				...
				location.href=('?tela_id=193&id_origem='+id_origem+'&id_destino='+id_destino+'&acao=cadastra');
			}
...
<table cellpadding="0" cellspacing="0" width="100%" id="tabela_dados" >
	...
	?>      
    	<tr <?=$sel?> onclick="location.href='?tela_id=193&acao=edit&id=<?=$r->transferencia_id?>&id_origem=<?=$origem->id?>&id_destino=<?=$destino->id?>&status=<?=$r->status?>'" >
