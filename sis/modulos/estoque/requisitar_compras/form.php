	...
	<fieldset  id='campos_2' style="display:none" >
    	...
    	<div style="max-height:250px; width:370px; overflow:auto;">
			...
			<div class="linha_add">
				...
				<label style="width:144px;">
					<input name="prod_comp_qtd[]" type="text" value="<?=moedaUsaToBr($y->requisitar_produto_qtd)?>" decimal="2" sonumero="1" style="text-align:right" >
				</label>
			...
			<div class="linha_add">
				...
				<label style="width:144px; margin-right:23px;">
					<select name="prod_comp_id[]">
						...
						while($s=mysql_fetch_object($f)){
							?>
							<option value="<?=$s->id?>"><?=$s->nome." (un:".$s->unidade.")"?></option>
							<?
						}
						?>
					</select>
				...
				<label style="width:144px;">
					<input name="prod_comp_qtd[]" type="text" value="" decimal="2" sonumero="1" style="text-align:right" >
				</label>
				<span style="clear:both; display:block"></span>
			</div>
       		<div style="clear:both; text-align:right;"><img src="../fontes/img/mais.png" width="18" height="18" onclick="add_element(this); location.hash='#ancora';" /> </div>
			</div>
			<a name="ancora"></a>
		</div>
	</fieldset>
