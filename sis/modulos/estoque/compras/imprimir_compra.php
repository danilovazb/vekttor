...
<body>
<?
$compra=mysql_fetch_object(mysql_query($t="SELECT * FROM estoque_compras WHERE id = '".$_GET['compra_id']."'"));
...
<tbody>
<?
	$itens = mysql_query($t="SELECT * FROM estoque_compras_item WHERE pedido_id = '".$_GET['compra_id']."' ORDER BY produto_id");
	//echo $t;
	$soma = 0;
