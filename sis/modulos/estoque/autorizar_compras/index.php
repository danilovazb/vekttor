...
<a href="?tela_id=74" class="navegacao_ativo">
<span></span>   Autorizar Compras
</a>
</div>
<div id="barra_info">
    <form action="" method="get" style="float:left">
		...
		<label for="status">Exibir:</label>
			...
			<option <? if(($_GET['status']=="Aguardo"||$_GET['status']=="")&&$_GET['ordem']=="")echo "selected='selected'" ?> value="Aguardo">Aguardo</option>
...
<table cellpadding="0" cellspacing="0" width="100%">
	...
	elseif(!$_GET['ordem'])$status="Aguardo";
