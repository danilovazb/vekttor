...
<table cellpadding="0" cellspacing="0" width="100%">
    ...
    $registros= mysql_result(mysql_query("SELECT count(*) FROM produto_grupo $busca_add ORDER BY id"),0,0);
	...
	$q= mysql_query("SELECT * FROM produto_grupo $busca_add ORDER BY ".$ordem." ".$_GET['ordem_tipo']." LIMIT ".paginacao_limite($registros,$_GET['pagina'],$_GET['limitador']));
