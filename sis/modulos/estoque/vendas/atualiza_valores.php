...
//echo $t;
	...
	$query=mysql_query($t="$sql estoque_vendas_item SET vkt_id='$vkt_id', pedido_id='".$_GET['pedido_id']."', produto_id='".$_GET['produto_id']."', fatorconversao='".moedaBrToUsa($_GET['conversao'])."' , qtd_pedida='".$_GET['qtd']."', valor_ini='".$_GET['valor']."' $fim");
	echo $t."<br>";
	echo mysql_error();
	//pr($_GET);
