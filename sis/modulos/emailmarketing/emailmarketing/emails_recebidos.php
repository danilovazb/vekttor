...
<table cellpadding="0" cellspacing="0" width="100%">
    ...
    $registros= mysql_result(mysql_query("SELECT count(*) FROM emailmarketing_retorno WHERE vkt_id = '$vkt_id' AND emailmarketing_id = '$id' $busca_add $filtro"),0,0);
	...
	while($r=mysql_fetch_object($q)){
		...
		$cliente_fornecedor = mysql_fetch_object(mysql_query("SELECT * FROM eleitoral_eleitores WHERE id='$r->cliente_fornecedor_id'"));
