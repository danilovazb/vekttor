	...
	<form onsubmit="return validaForm(this)" class="form_float"  method="post" enctype="multipart/form-data">
		...
		<fieldset>
          <legend>
            ...
            <?php
				$pergunta = mysql_fetch_object(mysql_query($t="SELECT * FROM  escolar_mensagens_privadas
															WHERE id='$mensagem->mensagem_origem_id'
															AND mensagem_origem_id='0'"));
				//echo $t."<br>";
			?>
              <label style="width:550px;"> <strong>Pergunta:</strong><?php echo $pergunta->mensagem?>
                           
              </label>
              <label style="width:550px;"> <strong>Resposta</strong><?php echo $mensagem->mensagem?>
                         
              </label>
              <label style="width:550px;">
              <strong>Perguntar Novamente</strong>
