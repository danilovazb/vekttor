    ...
    <thead>
    	<tr>
           <td width="40">Codigo</td>
            <td width="60">Totvs</td>
            <td width="200"><?=linkOrdem("Nome","nome_fantasia",1)?></td>
          	<td width="80"><?=linkOrdem("Telefone","Telefone",0)?></td>
          	<td width="130"><?=linkOrdem("Email","Email",0)?></td>
          	<td width="50"><?=linkOrdem("Turma","Turma",0)?></td>
            <td  width="70"><?=linkOrdem("Turno","Turno",0)?></td>
			<td></td>
        </tr>
    </thead>
</table>
...
<td width="40" align="right"><?=str_pad($r->id,5,"0",STR_PAD_LEFT)?></td>
<td  width="60"><?=$r->codigo_totvs?></td>
<td width="200"><?=$r->nome?></td>
<td width="80"><?=$r->telefone1?></td>
<td width="130"><?=$r->email?></td>
<td width="50"><?=$r->turma?></td>
<td  width="70"><?=$r->turno?></td>
<td></td>
</tr>
<?
	}
