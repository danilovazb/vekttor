...
$("#grupo_id").live("change",function(){
	...
	$("#remover_foto").live('click',function(){
		...
		window.open('modulos/ordem_servico/servicos/remover_foto.php?id='+id,'carregador');
	});
...
<div id="barra_info">
  ...
  <a href="modulos/ordem_servico/servicos/form.php" target="carregador" class="mais"></a>
...
<table cellpadding="0" cellspacing="0" width="100%" id="tabela_dados" >
	...
	?>      
    	<tr <?=$sel?> id="<?=$r->id?>" >
          <td width="60"><?=$r->codigo_interno?></td>
