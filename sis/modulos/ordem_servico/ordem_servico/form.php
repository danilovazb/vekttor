...
<div>
    ...
    <input type="hidden" name="situacao_orcamento" value="1">
        ...
        <label>
        	Garantia<br/>
            	<select name="garantia" id="garantia" <?=$disabled?>>
                	<option selected="selected" <? if($reg_os->garantia == '1'){echo 'selected="selected"';}?> value="1">Não</option>
        ...
        <div style="clear:both"></div>
        <label id="date_entrega">Previsão Entrega<br/>
       ...
       <fieldset id="campos_3" style="display:none">
		 <legend>
          ...
          <label style="width:160px">
            ...
            <div style="clear:both;"></div>
            <label style="width:175px;" title="Observação de Orçamento" rel="tip">
            Obs. Orçamento<br/>
            	<input type="text" name="obs_item_servico" id="obs_item_servico" <?=$disabled?>>
            </label>
            
            <label style="width:175px;" title="Observação de Produção" rel="tip">
            Obs. de Produção<br/>
       ...
       <legend>
        ...
        <label>
          ...
          <label>
           ...
           <label> <strong>Total Serviço</strong> <br/>
...
<!-- ABA CANCELAMENTNO  -->
	<fieldset id="campos_7" style="display:none">
		 <legend>
          ...
          <p>Para cancelar uma OS, é necessário digitar seu login e senha.</p>
           ...
           <table cellpadding="0" cellspacing="0" width="50%" >
               ...
               <tbody>
                  ...
                  <!--<tr style="background:#FFF">
                   ...
                   <tr style="background:#FFF">
                    <td width="300"><strong>DIFERENÇA</strong></td>
...
<? if( $vkt_id == 185 ) { ?>
<input type="button" value="Ordem Produção" id="imp_ordem_producao" />
<? 
	}
} 
?>
