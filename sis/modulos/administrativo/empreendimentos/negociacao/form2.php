	...
	<form onsubmit="return validaForm(this)" class="form_float" method="post">
		...
		<fieldset  id='campos_1' >
          ...
          <label style="width:220px;">
            Simulação com Tipo
            <select id='tipo_id' style="height:22px" onchange="document.getElementById('alerta').style.display='none';document.getElementById('valor').value=moedaUsaToBR(this.value);calcula_negociacao();">
			...
			<label style="width:130px;"> Valor Total R$
				<input type="text" id='valor' name="valor" value=""  decimal='2' style="text-align:right" disabled="disabled" />
			</label>
            <label style="width:80px;"> % Comissão
            ...
            <label style="width:80px;">Comissão R$
				<input type="text" id='valor_comissao' name="valor_comissao" onkeyup=" valor_porcento(vt(),this.value,'porcentagem_comissao');calcula_contrato();" value=""  decimal='2' style="text-align:right"  />
			</label>
            <label style="width:130px;"> Valor de Contrato R$
				<input type="text" id='contrato' name="contrato" value=""  decimal='2' style="text-align:right" disabled="disabled" />
			</label>
            ...
            <label style="width:90px;"> Ato Parcelas
				<input type="text" id='ato_parcelas' name="ato_parcelas" value="<?=moedaUsaToBr($r->ato_parcelas)?>"  style="text-align:right"  onkeyup="calcula_parcelas('valor_ato','ato_parcelas','ato_juros','ato_valor_parcela');"/>
			</label>
            ...
            <label style="width:90px;"> R$ Parcelas
				<input type="text" id='ato_valor_parcela' name="ato_valor_parcela" value=""  decimal='2' style="text-align:right"   disabled="disabled"/>
			</label>
          ...
          <div style="clear:both;"></div>
            ...
            <label style="width:90px;"> % Mensais
				<input type="text" id='porcentagem_mensais' name="porcentagem_mensais" value="<?=moedaUsaToBr($r->mensais_porcentagem)?>"  sonumero='1' decimal='2' style="text-align:right"  
                onkeyup="porcento_valor(vt(),this.value,'mensais_total'); calcula_restante(); "/>
		  </label>
          <label style="width:90px;"> R$ Mensais
				<input type="text" id='mensais_total' name="mensais_total" value="<?=moedaUsaToBr($r->mensais_valor)?>"  sonumero='1' decimal='2' style="text-align:right"  
			...
			<label style="width:90px;"> R$ Parcelas
				<input type="text" id='mensais_valor_parcelas' name="mensais_valor_parcelas" value=""  decimal='2' style="text-align:right"   disabled="disabled"/>
		  </label>
          ...
          <div style="clear:both;"></div>
             ...
             <label style="width:90px;"> % Semestrais
				<input type="text" id='porcentagem_semestrais' name="porcentagem_semestrais" value="<?=moedaUsaToBr($r->semestrais_porcentagem)?>"  sonumero='1' decimal='2' style="text-align:right"  
                onkeyup="porcento_valor(vt(),this.value,'semestrais_total'); calcula_restante(); "/>
		  </label>
          <label style="width:90px;"> R$ Semestrais
				<input type="text" id='semestrais_total' name="semestrais_total" value="<?=$r->entrada_parcelas?>"  sonumero='1' decimal='2' style="text-align:right"  
			...
			<label style="width:90px;"> R$ Parcelas
				<input type="text" id='semestrais_valor_parcelas' name="semestrais_valor_parcelas" value=""  decimal='2' style="text-align:right"   disabled="disabled"/>
		  </label>
          ...
          <label style="width:90px;"> % Anuais
				<input type="text" id='porcentagem_anuais' name="porcentagem_anuais" value="<?=moedaUsaToBr($r->anuais_porcentagem)?>"  sonumero='1' decimal='2' style="text-align:right"  
                onkeyup="porcento_valor(vt(),this.value,'anuais_total'); calcula_restante(); "/>
		  </label>
          <label style="width:90px;"> R$ Anuais
				<input type="text" id='anuais_total' name="anuais_total" value="<?=$r->entrada_parcelas?>"  sonumero='1' decimal='2' style="text-align:right"  
          ...
          <label style="width:90px;"> QTD Anuais
			...
			<label style="width:90px;"> R$ Parcelas
				<input type="text" id='anuais_valor_parcelas' name="anuais_valor_parcelas" value=""  decimal='2' style="text-align:right"   disabled="disabled"/>
		  </label>
          ...
          <label style="width:60px;">% Juros
			...
			<label style="width:90px;"> R$ Parcelas
				<input type="text" id='chave_valor_parcelas' name="chave_valor_parcelas" value=""  decimal='2' style="text-align:right"   disabled="disabled"/>
		  </label>
		  ...
		  <label style="width:90px; clear:both"> % Banco
				<input type="text" id='porcentagem_banco' name="porcentagem_banco" value="<?=moedaUsaToBr($r->banco_porcentagem)?>"  decimal='2' style="text-align:right" onkeyup="porcento_valor(vt(),this.value,'valor_banco');calcula_restante();" disabled="disabled" />
		  </label>
			<label style="width:90px;"> R$ Banco
				<input type="text" id='valor_banco' name="valor_banco" value=""  decimal='2' style="text-align:right" onkeyup="valor_porcento(vt(),this.value,'porcentagem_banco');calcula_restante();" disabled="disabled" />
		  </label>
			<label style="width:90px;"> Parcelas
...
<div style="clear:both;"></div>
			<label style="width:90px;"> A ser Pago
				<input type="text" id="restante" value=""  decimal='2' style="text-align:right" disabled="disabled" />
			</label>
Restrito
<br />
<input name="restrito" <? if($r->restrito=='1'){echo "checked='checked'";} ?> value="1" type="checkbox" />
            ...
            <input name="disponibilidade_id" type="hidden" value="<?=$r->disponibilidade_id?>" />
		</fieldset>
		<!--Fim dos fiels set-->
