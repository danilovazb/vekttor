...
include("_ctrl.php"); 
/*
$contrato = mysql_fetch_object(mysql_query($t="
SELECT 
	...
	c.nascimento as data_nascimento, 
	c.cnpj_cpf as cpf, 
	c.rg as rg, 
	c.local_emissao, 
	c.data_emissao,
	...
	e.administrador, 
	e.administrador_profissao, 
	e.administrador_estado_civil,
	e.administrador_rg, 
	e.administrador_orgao_expedidor,
	e.administrador_cpf, 
	e.administrador_endereco, 
	e.administrador_bairro,
...
<p align="justify"><br />
  Por  este <strong>CONTRATO PARTICULAR DE PROMESSA  DE COMPRA E VENDA DE UNIDADE AUT&Ocirc;NOMA</strong>, as partes abaixo mencionadas  t&ecirc;m entre si, ajustadas e contratadas, em car&aacute;ter irrevog&aacute;vel a presente  promessa de compra e venda, conforme segue:</p>
<p align="justify">&nbsp;</p>
<p align="justify"><strong>Das Partes:</strong></p>
<p align="justify">&nbsp;</p>
<p align="justify"><strong>1 &ndash; Promiss&aacute;rio  Vendedor: </strong></p>
<p align="justify">&nbsp;</p>
<p align="justify"><strong><?= $empreendimento->nome?></strong>, inscrita no CNPJ n&ordm; <?=$empreendimento->cnpj?>, com sede na  cidade de <?= $empreendimento->cidade?> situada no(a) <?= $empreendimento->logradouro?>, <?= $empreendimento->Bairro." ".$empreendimento->complemento?>, neste ato representada por seu s&oacute;cio administrador <?= $empreendimento->administrador.", ".$empreendimento->administrador_profissao.", ".$empreendimento->administrador_estado_civil ?>, portador da Carteira de Identidade n&ordm;. <?= $empreendimento->administrador_rg	."/".$empreendimento->orgao_adm?>, e CPF/MF n&ordm;.  <?= $empreendimento->administrador_cpf?>, residente e domiciliado nesta cidade no(a) <?= $empreendimento->administrador_endereco.", ".$empreendimento->administrador_bairro?> </p>
...
<p align="justify">&nbsp;</p>
<p align="justify"><strong>PRE&Ccedil;O: </strong>O pre&ccedil;o da unidade  objeto deste contrato &eacute; de R$ 
  <?= number_format($contrato->valor_contrato,2,",",".")?>
  , e ser&aacute; pago pelo(s) <strong>PROMISS&Aacute;RIO(S) COMPRADOR(ES)</strong> nas  condi&ccedil;&otilde;es especificadas neste contrato resumo, sujeitas as presta&ccedil;&otilde;es aos  encargos (corre&ccedil;&atilde;o monet&aacute;ria e juros) indicados nas cl&aacute;usulas segunda e  terceira da parte 2 deste contrato. </p>
<div align="justify">
...
<p align="justify"><strong>Par&aacute;grafo Primeiro</strong>: A parcela denominada &acute;&acute;parcela  final`` do pre&ccedil;o, dever&aacute; ser pagas com recursos pr&oacute;prios do(s) <strong>PROMISS&Aacute;RIO(S) COMPRADOR(ES)</strong> reajustada  na forma prevista neste contrato; Ou por meio de repasse pela <strong>CAIXA ECON&Ocirc;MICA FEDERAL</strong> diretamente &agrave; <strong>VENDEDORA</strong>, em at&eacute; 30 dias ap&oacute;s a  notifica&ccedil;&atilde;o enviada pela <strong>VENDEDORA</strong> nos termos da cl&aacute;usula 1.5 deste contrato, na forma e prazos estipulados no  Instrumento de Cr&eacute;dito Banc&aacute;rio &ndash; Financiamento Banc&aacute;rio com Aliena&ccedil;&atilde;o  Fiduci&aacute;ria do Im&oacute;vel e outras aven&ccedil;as a ser firmado pela <strong>CAIXA ECON&Ocirc;MICA FEDERAL</strong> com o <strong>COMPRADOR</strong>. </p>
...
<p align="justify"><strong>3.3. cliente que optar  por financiamento banc&aacute;rio junto a CAIXA n&atilde;o arcar&aacute; com despesas referente ao  &Iacute;ndice Geral de Pre&ccedil;os &ndash; Mercado (IGPM) e &Iacute;ndice Nacional de Custo da  Constru&ccedil;&atilde;o (INCC), entretanto, ap&oacute;s a assinatura do contrato de financiamento  banc&aacute;rio dever&aacute; arcar com as despesas da Planilha de Custo Efetivo, referente  ao andamento da obra;</strong><br />
  &nbsp;<br />
  <strong>3.4. </strong>Na hip&oacute;tese de extin&ccedil;&atilde;o, congelamento  ou proibi&ccedil;&atilde;o de utiliza&ccedil;&atilde;o dos &iacute;ndices de atualiza&ccedil;&atilde;o pactuados neste  instrumento, as partes desde j&aacute; elegem o &Iacute;ndice de Pre&ccedil;os ao Consumidor da  Funda&ccedil;&atilde;o Instituto de Pesquisas Econ&ocirc;micas (IPC &ndash; FIPE) ou, sucessivamente, o  IGP-DI/FGV, em substitui&ccedil;&atilde;o.<br />
  <strong>3.5. </strong>O(s) <strong>PROMISS&Aacute;RIO(S) COMPRADOR(ES) </strong>poder&aacute; (&atilde;o) antecipar o pagamento das  parcelas do pre&ccedil;o, de acordo com as seguintes condi&ccedil;&otilde;es:</p>
...
<p align="justify">a)  clientes do Programa Minha Casa Minha Vida (PMCMV) ter&atilde;o as despesas referente  a emolumentos, registro e taxa do Imposto de Transmiss&atilde;o de Bens Im&oacute;veis  (ITBI), pagos pela <strong>VENDEDOR(A)</strong></p>
...
<p align="justify">b)  Suspens&atilde;o ou falta, total ou parcial, de transporte, materiais, combust&iacute;veis,  energia el&eacute;trica ou &aacute;gua;<br />
  c)  Chuvas prolongadas que impe&ccedil;am ou dificultem a execu&ccedil;&atilde;o da obra de constru&ccedil;&atilde;o  do <strong>EDIF&Iacute;CIO</strong>.</p>
...
<p align="justify">&nbsp;</p>
<p align="justify"><strong>9.1.</strong> O(s) <strong>PROMISS&Aacute;RIO(S) COMPRADOR(ES)</strong> poder&aacute;(&atilde;o) ceder ou transferir os  direitos relativos ao presente contrato somente mediante a prevista e expressa  autoriza&ccedil;&atilde;o da <strong>VENDEDORA</strong>, podendo  esta exercer prefer&ecirc;ncia, nas mesmas condi&ccedil;&otilde;es ofertadas pelo terceiro  interessado.</p>
<p align="justify"><strong>9.2.</strong> Caso a <strong>VENDEDORA </strong>n&atilde;o exer&ccedil;a a prefer&ecirc;ncia, apesar de intimada para tanto  com prazo de 10 (dez) dias, devera autorizar a cess&atilde;o observadas &agrave;s seguintes  condi&ccedil;&otilde;es, cumulativamente:</p>
...
<p align="justify">&nbsp;</p>
<p align="justify">Cidade  de Manaus-AM,
  <?= date('d/m/Y')?>
  .</p>
<p align="justify">&nbsp;</p>
...
<div align="justify">
  <table border="1" cellspacing="0" cellpadding="0">
    <tr>
      <td width="375" valign="top"><p>&nbsp;</p>
        <p>NOME:</p>
        <p>CPF:</p>
        <p>RG:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </p></td>
      <td width="376" valign="top"><p>&nbsp;</p>
        <p>NOME:</p>
        <p>CPF:</p>
        <p>RG:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </p></td>
      </tr>
