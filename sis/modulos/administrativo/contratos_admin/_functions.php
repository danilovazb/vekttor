...
function novaVenda(){
	...
	3 - Altera status da disponibilidade
	4 - de acordo com a negociação id
		cria boleto de entrada
		cria os boletos da  contrutora (mensal Semestral ou anual)
	*/	
	global $login_id;
	
	mysql_query($t="UPDATE disponibilidade SET situacao='1' WHERE id='{$_POST[disponibilidade_id]}' ");
