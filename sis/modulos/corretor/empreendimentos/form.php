...
<input name="action" type="button"  value="Venda" style="float:right; margin-right:5px;"  />
...
<input name="action" type="button"  value="Tipos de Disponibilidade" style="float:right; margin-right:5px;" onclick="location.href='?tela_id=65&empreendimento_id=<?=$r->id?>'" />
