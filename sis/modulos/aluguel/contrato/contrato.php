...
<div id="barra_info">
<a href="modulos/aluguel/contrato/form.php" target="carregador" class="mais"></a>
</div>
...
<div id="pagina">
<?php
	$contrato = mysql_fetch_object(mysql_query($t="SELECT * FROM aluguel_contrato WHERE id='$vkt_id'"));
