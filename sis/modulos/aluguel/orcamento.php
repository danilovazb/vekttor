...
$("#click_despesa").live('click',function(){
	...
	$("#tbody_despesa").append("<tr class='col'><td style='border-left:1px solid #CCC;'>"+despesas+"<input type='hidden' name='despesas[]' class='despesas' value="+despesas+"><input type='hidden' name='id_despesa[]' value='novo'/></td><td style='width:45px;'>"+qtd+"<input type='hidden' name='qtd_despesas[]' class='qtd_despesas' value="+qtd+"></td><td style='width:65px;'>"+moedaUsaToBR(valor_despesa.toFixed(2))+"<input type='hidden' name='valor_despesa[]' class='valor_despesa' value="+valor_despesa+"></td><td style='width:65px;' class='valor_t'>"+moedaUsaToBR(valor_total.toFixed(2))+"</td><td style='width:45px;'><img src='../fontes/img/menos.png' id='excluir_despesa'></td></tr>");
...
$("#excluir_despesa").live("click",function(){
	...
	$(this).parent().parent().find('.despesas').val('-1');
