...
<span></span>    Mensalidades Clientes
</a>
...
<div id="barra_info">
 <input type="button" id="voltar" value="<<">
 <span style="float:right">
  	...
  	<?php 
		if(empty($_GET["de"])&&empty($_GET["ate"])){ 
			...
			echo "Periodo: ".$_GET['de']." a ".$_GET['ate'];
		}?>
  </span>
...
<thead>
    	<tr>
          ...
          <td width="95">Qtd Mensalidade</td>
          <td width="95">% Mensalidade</td>
          <td width="95">Vlr Mensalidade</td>          
           <td></td>
        </tr>
    </thead>
</table>
...
?>      
        ...
        <tr>
         <td width="50">1</td>
          <td width="200">Cliente 1</td>
          <td width="95">7</td>
          <td width="95">45%</td>
          <td width="100">R$ 7.000,00</td>          
          <td></td>
        </tr>
        <tr>
         <td width="50">2</td>           
          <td width="200">Cliente 2</td>
          <td width="95">8</td>
          <td width="95">55%</td>
          <td width="100">R$ 3.0000</td>
           <td></td>
        </tr>
<?php
		//}
