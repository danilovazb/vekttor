...
if( isset($_POST) ){
	...
	$dadosboleto["variacao_carteira"] = $_POST['v5'];  // Variação da Carteira, com traço (opcional)
	
	// TIPO DO BOLETO
	$convenio_dig = strlen($dadosboleto["convenio"]);
	$dadosboleto["formatacao_convenio"] = $convenio_dig; // REGRA: 8 p/ Convênio c/ 8 dígitos, 7 p/ Convênio c/ 7 dígitos, ou 6 se Convênio c/ 6 dígitos
