...
<div id="container">
  ...
  <tr>
    ...
    <?
    if($_POST['tipo_matricula']== 'MATRÍCULA'){
	?>
      <strong>ALUNOS NOVOS: </strong>Este cart&atilde;o quitado, RG, CPF, Comprovante Resid&ecirc;ncia.<br>
      
      <strong>PRAZO DE ENTREGA DE DOCUMENTOS:</strong> 18/01/2012
        <br>
    <?
	}
    if($_POST['tipo_matricula']== 'REMATRÍCULA'){
	?>
        <strong>ALUNOS VETERANOS</strong>: Este cart&atilde;o quitado        , Comprovante Resid&ecirc;ncia<br> <strong>PRAZO DE ENTREGA DE DOCUMENTOS:</strong>11/01/2012
        
     <?
	}
	 ?>
      </p></td>
    <td width="46%" valign="top"><p><strong>Observa&ccedil;&atilde;o:</strong> Em virtude do armazenamento eletrônico, deverão ser apresentado os originais e c&oacute;pias de todos os documentos. Ap&oacute;s a conferência, os originais serão devolvidos ao candidato no ato da matr&iacute;cula.</p></td>
  </tr>
</table>
        ...
        <div>
          <p><strong>Declara&ccedil;&atilde;o:</strong> Eu, <?php echo $dadosboleto["sacado"]?> declaro ter lido e  aceito os termos constantes na unidade 
            <?=$_POST['escola_nome']?>
             publicado no dia    <?php echo $dadosboleto["data_vencimento"]?>. </p>
        </div>  
                </td>
              </tr>
            </tbody>
