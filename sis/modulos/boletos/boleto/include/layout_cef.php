...
<body text="#000000" bgcolor="#FFFFFF" topmargin="0" rightmargin="0">
    ...
    <table cellspacing="0" cellpadding="0" width="666" border="0">
        <tbody>
            <tr>
                <td class="ct" width="666"><img height="1" src="imagens/6.png" width=
                "665" border="0" /></td>
            </tr>
    ...
    <table cellspacing="0" cellpadding="0" width="666" border="0">
        <tr>
            ...
            "imagens/logocaixa.jpg" width="150" height="40" border="0" /></span></td>

            <td width="3" valign="bottom"><img height="22" src="imagens/3.png" width="2"
            border="0" /></td>

            <td class="cpt" width="58" valign="bottom">
                <div align="center">
                    <font class=
                    "bc"><?php echo $dadosboleto["codigo_banco_com_dv"]?></font>
                </div>
            </td>
            ...
            <td class="ld" align="right" width="453" valign="bottom"><span class=
            "ld"><span class=
            "campotitulo"><?php echo $dadosboleto["linha_digitavel"]?></span></span></td>
        </tr>

        <tbody>
            <tr>
                <td colspan="5"><img height="2" src="imagens/2.png" width="666" border=
                "0" /></td>
            </tr>
        </tbody>
    </table>
    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tbody>
            <tr>
                <td class="ct" valign="top" width="7" height="13"><img height="13" src=
                "imagens/1.png" width="1" border="0" /></td>
                ...
                Ag&#195;&#170;ncia/C&#195;&#179;digo do Cedente</td>
            ...
            <tr>
                <td class="cp" valign="top" width="7" height="12"><img height="12" src=
                "imagens/1.png" width="1" border="0" /></td>

                <td class="cp" valign="top" width="268" height="12"><span class=
                "campo"><?php echo $dadosboleto["cedente"]; ?></span></td>

                <td class="cp" valign="top" width="7" height="12"><img height="12" src=
                "imagens/1.png" width="1" border="0" /></td>

                <td class="cp" valign="top" width="156" height="12"><span class=
                "campo"><?php echo $dadosboleto["agencia_codigo"]?></span></td>

                <td class="cp" valign="top" width="7" height="12"><img height="12" src=
                "imagens/1.png" width="1" border="0" /></td>

                <td class="cp" valign="top" width="34" height="12"><span class=
                "campo"><?php echo $dadosboleto["especie"]?></span></td>

                <td class="cp" valign="top" width="7" height="12"><img height="12" src=
                "imagens/1.png" width="1" border="0" /></td>

                <td class="cp" valign="top" width="53" height="12"><span class=
                ...
                <span class="campo"><?php echo $dadosboleto["nosso_numero"]?></span></td>
            </tr>

            <tr>
                <td valign="top" width="7" height="1"><img height="1" src="imagens/2.png"
                width="7" border="0" /></td>

                <td valign="top" width="268" height="1"><img height="1" src=
                "imagens/2.png" width="268" border="0" /></td>

                <td valign="top" width="7" height="1"><img height="1" src="imagens/2.png"
                width="7" border="0" /></td>

                <td valign="top" width="156" height="1"><img height="1" src=
                "imagens/2.png" width="156" border="0" /></td>

                <td valign="top" width="7" height="1"><img height="1" src="imagens/2.png"
                width="7" border="0" /></td>

                <td valign="top" width="34" height="1"><img height="1" src=
                "imagens/2.png" width="34" border="0" /></td>

                <td valign="top" width="7" height="1"><img height="1" src="imagens/2.png"
                width="7" border="0" /></td>

                <td valign="top" width="53" height="1"><img height="1" src=
                "imagens/2.png" width="53" border="0" /></td>

                <td valign="top" width="7" height="1"><img height="1" src="imagens/2.png"
                width="7" border="0" /></td>

                <td valign="top" width="120" height="1"><img height="1" src=
                "imagens/2.png" width="120" border="0" /></td>
            </tr>
        </tbody>
    </table>
    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tbody>
            <tr>
                ...
                <td class="ct" valign="top" colspan="3" height="13">N&#195;&#186;mero do
                documento</td>
            ...
            <tr>
                ...
                <td class="cp" valign="top" colspan="3" height="12"><span class=
                "campo"><?php echo $dadosboleto["numero_documento"]?></span></td>

                <td class="cp" valign="top" width="7" height="12"><img height="12" src=
                "imagens/1.png" width="1" border="0" /></td>

                <td class="cp" valign="top" width="132" height="12"><span class=
                "campo"><?php echo $dadosboleto["cpf_cnpj"]?></span></td>

                <td class="cp" valign="top" width="7" height="12"><img height="12" src=
                "imagens/1.png" width="1" border="0" /></td>

                <td class="cp" valign="top" width="134" height="12"><span class=
                ...
                <span class="campo"><?php echo $dadosboleto["valor_boleto"]?></span></td>
            </tr>
            ...
            <tr>
                ...
                "imagens/2.png" width="113" border="0" /></td>

                <td valign="top" width="7" height="1"><img height="1" src="imagens/2.png"
                width="7" border="0" /></td>

                <td valign="top" width="72" height="1"><img height="1" src=
                "imagens/2.png" width="72" border="0" /></td>

                <td valign="top" width="7" height="1"><img height="1" src="imagens/2.png"
                width="7" border="0" /></td>

                <td valign="top" width="132" height="1"><img height="1" src=
                "imagens/2.png" width="132" border="0" /></td>

                <td valign="top" width="7" height="1"><img height="1" src="imagens/2.png"
                width="7" border="0" /></td>

                <td valign="top" width="134" height="1"><img height="1" src=
                "imagens/2.png" width="134" border="0" /></td>

                <td valign="top" width="7" height="1"><img height="1" src="imagens/2.png"
                width="7" border="0" /></td>

                <td valign="top" width="180" height="1"><img height="1" src=
                "imagens/2.png" width="180" border="0" /></td>
            </tr>
        </tbody>
    </table>
    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tbody>
            <tr>
                ...
                <td class="ct" valign="top" width="112" height="13">(-) Outras
                dedu&#195;&#167;&#195;&#181;es</td>
            ...
            <tr>
                ...
                <td valign="top" width="112" height="1"><img height="1" src=
                "imagens/2.png" width="112" border="0" /></td>
    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tbody>
            ...
            <tr>
                ...
                <td class="cp" valign="top" width="659" height="12"><span class=
                "campo"><?php echo $dadosboleto["sacado"]?></span></td>
            </tr>
            ...
            <tr>
                ...
                <td valign="top" width="659" height="1"><img height="1" src=
                "imagens/2.png" width="659" border="0" /></td>
            </tr>
        </tbody>
    </table>
    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tbody>
            <tr>
                ...
                <td class="ct" width="88">Autentica&#195;&#167;&#195;&#163;o
                mec&#195;&#162;nica</td>
            </tr>
    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tbody>
            ...
            <tr>
                ...
                <td class="cp" valign="top" width="472" height="12">Pag&#195;&#161;vel em
                qualquer Banco at&#195;&#169; o vencimento</td>
            ...
            <tr>
                ...
                <td valign="top" width="472" height="1"><img height="1" src=
                "imagens/2.png" width="472" border="0" /></td>
    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tbody>
            ...
            <tr>
                ...
                <td class="cp" valign="top" width="472" height="12"><span class=
                "campo"><?php echo $dadosboleto["cedente"]?></span></td>
    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tbody>
            <tr>
                ...
                <td class="ct" valign="top" width="62" height="13">Esp&#195;&#169;cie
                doc.</td>
            ...
            <tr>
                ...
                <td class="cp" valign="top" width="133" height="12"><span class=
                "campo"><?php echo $dadosboleto["numero_documento"]?></span></td>
            ...
            <tr>
                ...
                "imagens/2.png" width="133" border="0" /></td>

                <td valign="top" width="7" height="1"><img height="1" src="imagens/2.png"
                width="7" border="0" /></td>

                <td valign="top" width="62" height="1"><img height="1" src=
                "imagens/2.png" width="62" border="0" /></td>
                ...
                "imagens/2.png" width="102" border="0" /></td>
    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tbody>
            <tr>
                ...
                <td class="ct" valign="top" height="13" width="7"><img height="13" src=
                "imagens/1.png" width="1" border="0" /></td>
    ...
    <table cellspacing="0" cellpadding="0" width="666" border="0">
        <tbody>
            <tr>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" align="left">
                        <tbody>
                            <tr>
                                ...
                                <img height="13" src="imagens/1.png" width="1" border=
                                "0" /></td>
                            </tr>

                            <tr>
                                <td class="cp" valign="top" width="7" height="12">
                                <img height="12" src="imagens/1.png" width="1" border=
                                "0" /></td>
                            </tr>
                ...
                <td valign="top" width="468" rowspan="5"><font class=
                "ct">Instru&#195;&#167;&#195;&#181;es (Texto de responsabilidade do
                cedente)</font><br />
                <br />
    ...
    <table cellspacing="0" cellpadding="0" width="666" border="0">
        <tbody>
            <tr>
                <td valign="top" width="666" height="1"><img height="1" src=
                "imagens/2.png" width="666" border="0" /></td>
            </tr>
        </tbody>
    </table>
    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tbody>
            <tr>
                ...
                <td class="cp" valign="top" width="659" height="12"><span class=
                "campo"><?php echo $dadosboleto["endereco1"]?></span></td>
            </tr>
        </tbody>
    </table>
    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <tbody>
            <tr>
                ...
                <td class="cp" valign="top" width="472" height="13"><span class=
                "campo"><?php echo $dadosboleto["endereco2"]?></span></td>

                <td class="ct" valign="top" width="7" height="13"><img height="13" src=
                "imagens/1.png" width="1" border="0" /></td>

                <td class="ct" valign="top" width="180" height="13">C&#195;&#179;d.
                baixa</td>
            </tr>
        ...
        <tbody>
            <tr>
                ...
                <td class="ct" width="250">
                    <div align="right">
                        Autentica&#195;&#167;&#195;&#163;o mec&#195;&#162;nica -
                        <b class="cp">Ficha de Compensa&#195;&#167;&#195;&#163;o</b>
                    </div>
                </td>
            </tr>
    ...
    <table cellspacing="0" cellpadding="0" width="666" border="0">
        <tbody>
            <tr>
                ...
                <?php fbarcode($dadosboleto["codigo_barras"]); ?></td>
            </tr>
        </tbody>
    </table>
