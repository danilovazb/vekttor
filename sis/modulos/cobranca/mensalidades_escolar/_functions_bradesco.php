...
function fbarcode($V01773a8a){
    ...
    $b.="<img src=../../i/p.gif width=$V77e77c6a><img 
	src=../../i/b.gif width=$V77e77c6a><img 
	src=../../i/p.gif width=$V77e77c6a><img 
	src=../../i/b.gif width=$V77e77c6a><img 
    ";
    ...
    $b.="
	 src=../../i/p.gif width=$Vbd19836d><img 
     ";
	...
	$b.="
	 src=../../i/b.gif width=$V3667f6a0><img 
	";
	 }
	}
	 
	$b.="
	src=../../i/p.gif width=$V5f44b105><img 
	src=../../i/b.gif width=$V77e77c6a><img 
	src=../../i/p.gif width=1>";
	return $b;
} 
