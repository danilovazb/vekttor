<?php
	...
	function insere_arquivo(){
		...
		if($extensao!='php'){
			...
			mysql_query($ql=" INSERT INTO escolar2_upload
			  SET
				aula_id = '$aula_id',
				vkt_id  = '$vkt_id',
				extensao = '$extensao',
				localizacao = '../upload/escolar2/',
			...
			*/
			...
			if(move_uploaded_file($_FILES['arquivo']['tmp_name'], "../upload/escolar2/$arquivo")){	
				echo "<script> top.location='?tela_id=286&aula=$aula_id'; </script> ";
				
				mysql_query(" UPDATE escolar2_upload SET arquivo = '".$id_aula.'.'.$extensao."' WHERE id = '".$id_aula."' ");
				exit();
