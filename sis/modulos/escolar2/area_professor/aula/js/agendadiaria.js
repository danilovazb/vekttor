					...
					/* Pegar data e hora Final */ 
						var mes_fim = (final.getMonth())+1;
						  ...
						  /*-Pegar Hora Final -*/
							...
							window.open("modulos/escolar2/calendario_escolar/form.php?dataInicial="+dataInicial+'&horaInicial='+hora_inicial+'&dataFinal='+dataFim+'&horaFinal='+hora_final,'carregador');
