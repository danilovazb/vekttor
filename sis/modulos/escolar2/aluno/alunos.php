    ...
    <div id="dados">
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            ...
            <?php
				...
				SELECT COUNT(*) FROM escolar2_alunos AS aluno WHERE aluno.vkt_id = '$vkt_id' $and_busca  
				
				"),0,0);
				
				$sql = mysql_query(" SELECT *, aluno.id AS aluno_id FROM escolar2_alunos AS aluno 
				...
				$and_busca ORDER BY aluno.nome  
				
				LIMIT ".paginacao_limite($registros,$_GET[pagina],$_GET[limitador]));	
            	
				$total_alunos = mysql_num_rows($sql);
            ...
            ?>
                ...
                <tr <?php echo $cl; ?> onclick="window.open('modulos/escolar2/aluno/form.php?aluno_id=<?php echo $r->aluno_id; ?>','carregador')">
                    <td width="30"><?php echo $total;?></td>
                    <td width="260" style="text-transform:uppercase;"><?php echo $r->nome;?></td>
