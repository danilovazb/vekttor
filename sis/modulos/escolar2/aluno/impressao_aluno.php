...
global $vkt_id;
	$aluno       = mysql_fetch_object(mysql_query("SELECT * from escolar2_alunos WHERE id = ".$_GET['id']." AND vkt_id='$vkt_id' "));
	
	$matricula  = mysql_fetch_object(mysql_query($t="SELECT * FROM escolar2_matriculas WHERE aluno_id = ".$_GET['id']." AND vkt_id='$vkt_id' ORDER BY id DESC LIMIT 1"));
	$turma = mysql_fetch_object(mysql_query($t="SELECT * from escolar2_turmas WHERE id =  '".$matricula->turma_id."' AND vkt_id='$vkt_id' ORDER BY id DESC LIMIT 1"));
	
	$periodo   = mysql_fetch_object(mysql_query($p="SELECT * from escolar2_periodo_letivo WHERE id = ".$turma->periodo_letivo_id." AND vkt_id='$vkt_id'"));
