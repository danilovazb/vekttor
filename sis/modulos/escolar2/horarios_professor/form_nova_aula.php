...
<div>
	...
	<fieldset>
        ...
        <div style="width:100%; max-height:80px;">
            ...
            <? 
			if( $info_aula->status == 1){ 
			?>
        	 
            <div style="padding:5px; margin:5px;min-height:15px;">
    
            	<div style="float:left;padding:2px;"> <a href="#" id="clickFrequencia" class="frequencia lancar"> Realizar Frequ&ecirc;ncia</a> </div>
            	
                <div style="float:left;padding:2px;"> <a href="#" id="clickObservacao" class="frequencia lancar"> Ocorr&ecirc;ncias Alunos </a> </div>
                
            </div>  
            
			<? } if($info_aula->status == 2){ ?>
           
            <div style="padding:5px; margin:5px; min-height:15px;">
            	<div style="float:left;padding:2px;"  > <a href="#" id="clickFrequencia" class="realizada"> Frequ&ecirc;ncia Lançada</a> </div>
            	<div style="float:left;padding:2px;"> <a href="#" id="clickObservacao" class="frequencia lancar"> Ocorr&ecirc;ncias Alunos </a> </div>
            </div>
			<? }?>
