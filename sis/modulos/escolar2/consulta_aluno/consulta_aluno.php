    ...
    <div id="dados">
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            ...
            <?php
				...
				$sql = mysql_query(" SELECT * FROM escolar2_alunos WHERE vkt_id = '$vkt_id' $and_busca ");	
            ...
            ?>
                ...
                <tr <?php echo $cl; ?> onclick="window.open('modulos/escolar2/consulta_aluno/form.php?aluno_id=<?php echo $r->id; ?>','carregador')">
