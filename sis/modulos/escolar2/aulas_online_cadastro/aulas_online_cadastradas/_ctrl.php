...
if($materia_id>0&&$modulo_id>0){
	$materia=mysql_fetch_object(mysql_query("SELECT * FROM escolar2_materias WHERE vkt_id='$vkt_id' AND id='$materia_id' AND modulo_id='$modulo_id'"));
}
if($aula_id>0){
	$aula=mysql_fetch_object(mysql_query("SELECT * FROM escolar2_aulas_online WHERE vkt_id='$vkt_id' AND id='$aula_id'"));
