...
?>
    ...
    <div id="navegacao">
        ...
        <a href="./?tela_id=<?=$_GET[tela_id]?>" class="navegacao_ativo">Cadastro de aulas online<span></span></a>
    </div>
...
<?												
										$s_modulos =mysql_query($t =" SELECT distinct(s.modulo_id) as id, m.nome 
											...
											while($modulos=mysql_fetch_object($s_modulos)){
												/*----------------------*/
?>
                <tr <?php echo $cl; ?> onclick="location='?tela_id=325&modulo_id=<?=$modulos->id?>'" >
