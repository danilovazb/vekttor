...
<div id="conteudo">
    ...
    <?
		...
		$escolas=mysql_query($t="SELECT * FROM escolar2_unidades WHERE vkt_id='$vkt_id' LIMIT ".paginacao_limite($registros,$_GET[pagina],$_GET[limitador]));
...
<div id="rodape">
	...
	if(!id>0){
		...
		console.log(val)
		obj="<div class='sala'>"+
		"<label style=\"width:100px;\">Nome da sala<input name='nome[]' type=\"text\" />"+
		"</label><label style=\"width:110px;\">Capacidade máxima <input name='capacidade_max[]' type=\"text\" />"+
		"</label><label style=\"width:130px;\">Capacidade Pedagógica<input name='capacidade_ped[]' type=\"text\" /></label>"+
