...
$(document).ready(function (){ 
	$("#tabela_dados tr").live("click",function(){
		var id = $(this).attr('id');
		window.open('modulos/escolar2/materia/form.php?id='+id,'carregador');
	});
});
</script>
...
<div id="conteudo">
  ...
  //  pr($_POST);
    ...
    <div id="navegacao">
        ...
        <a href="?tela_id=<?=$_GET[tela_id]?>" class="navegacao_ativo"><span></span>Mat&eacute;ria</a>
    </div>
    ...
    -->
    <div id="barra_info">
        <a href="modulos/escolar2/materia/form.php" target="carregador" class="mais"></a>	
    </div>
    <!--
        ///////////////////////////////////////
        Cabeçalho da tabela
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <thead>
            <tr>
                <td width="220">Mat&eacute;ria</td>
...
<table cellpadding="0" cellspacing="0" width="100%" id="tabela_dados">
    <tbody>
    <?php
    $sql = mysql_query(" SELECT * FROM escolar2_materias WHERE vkt_id = '$vkt_id' ORDER BY nome ASC");
		
		while($materia=mysql_fetch_object($sql)){
			
	?>
    <tr id="<?=$materia->id?>">
        <td width="220"><?=$materia->nome?></td>
        <td>&nbsp;</td>
    </tr>     
    <?php
		}
