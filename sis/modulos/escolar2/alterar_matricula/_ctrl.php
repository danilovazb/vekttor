...
if ( $_GET['id'] > 0 ) {
	...
	$mat_atual = mysql_fetch_object(mysql_query($mt="
		SELECT *, 
			...
			matricula.valor_matricula AS vlr_matricula,
			matricula.valor_mensalidade AS vlr_mens
	...
	$responsavel = mysql_fetch_object(mysql_query($t="SELECT * FROM cliente_fornecedor WHERE id = '$matricula->responsavel_id' "));
	echo $t;
