...
$(document).ready(function(){
	...
	$("#tabela_dados tr").live("click",function(){
		...
		window.open('modulos/escolar2/alterar_matricula/form.php?id='+id+"&matricula_id="+matricula_id,'carregador');
	});
});
...
<div id="conteudo">
    ...
    <div id="navegacao">
        ...
        <a href="./" class='s2'>Administração</a>
        <a href="?tela_id=506" class="navegacao_ativo"><span></span>Alterar valor matrícula</a>
    </div>
    ...
    <div id="barra_info">
	 ...
	 <input type="hidden" name="tela_id" value="473" />
       ...
       <!--<select name="tipo_matricula" class="tipo_matricula" id='tipo_matricula' style="margin-top:3px;">
	...
	?>
        <table cellpadding="0" cellspacing="0" width="100%" id="tabela_dados">
          ...
          <?php
			...
			if(!empty($_GET["tipo_matricula"]))
				$filtro_barro_info .= " AND matricula.status = '".$_GET["tipo_matricula"]."'";
			...
			$sql_matricula = mysql_query(" SELECT *,matricula.id AS matricula_id FROM escolar2_matriculas AS matricula $filter 
