...
$(document).ready(function (){ 
	$("#tabela_dados tr").live("click",function(){
		var id = $(this).attr('id');
		window.open('modulos/escolar2/serie/form.php?id='+id,'carregador');
	});
});
</script>
...
<div id="conteudo">
  ...
  //  pr($_POST);
    ...
    <div id="navegacao">
        ...
        <a href="?tela_id=<?=$_GET[tela_id]?>" class="navegacao_ativo"><span></span>S&eacute;rie</a>
    </div>
    ...
    -->
    <div id="barra_info">
        <a href="modulos/escolar2/serie/form.php" target="carregador" class="mais"></a>	
    </div>
    <!--
        ///////////////////////////////////////
        Cabeçalho da tabela
...
<table cellpadding="0" cellspacing="0" width="100%" id="tabela_dados">
    <tbody>
    <?php
    $sql = mysql_query(" SELECT * FROM escolar2_series WHERE vkt_id = '$vkt_id' ORDER BY ordem_ensino ASC ");
		
		while($serie=mysql_fetch_object($sql)){
		$ensino = mysql_fetch_object(mysql_query(" SELECT * FROM escolar2_ensino WHERE id = '$serie->ensino_id' "));
			
	?>
    <tr id="<?=$serie->id?>">
        <td width="220"><?=$serie->nome?></td>
