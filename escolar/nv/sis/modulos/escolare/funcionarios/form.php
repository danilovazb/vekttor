        ...
        <label style="width:126px;">
         ...
         <label>
    		...
    		<select name="f_estatus_professor" >
    			<option></option>
        		<option <? if($professor->estatus_professor=='contratado')echo "selected='selected'"; ?> value="contratado">Diretor</option>
        		<option <? if($professor->estatus_professor=='efetivo/concursado')echo "selected='selected'"; ?> value="efetivo/concursado">Secretario</option>
        		<option <? if($professor->estatus_professor=='estagio probatorio')echo "selected='selected'"; ?> value="estagio probatorio">Professor</option>
