...
<div id="barra_info">
    Descricao Aula:<input type="text" name="descricao" style="width:300px;">
    Data:<input type="text" name="data" size="8" calendario="1">
...
<table cellpadding="0" cellspacing="0" width="100%">
	...
	<tr>
   		<td width="40">1</td>
   		<td width="200">Gilderbrando da Silva</td>
   		<td width="70"><input type="checkbox" name="p1" id="" checked="checked"></td>
   		<td></td>
	</tr>
    <tr>
   		<td width="40">2</td>
   		<td width="200">Jaime Barroso Neves</td>
   		<td width="70"><input type="checkbox" name="p2" id="" checked="checked"></td>
   	   	<td></td>
	</tr>
    <tr>
   		<td width="40">3</td>
   		<td width="200">Ricardo Lima</td>
   		
   		<td width="70"><input type="checkbox" name="p3" id="" checked="checked"></td>
     <td></td>
    <tr>
   		<td width="40">1</td>
   		<td width="200">Mario Novo</td>
   		<td width="70"><input type="checkbox" name="p4" id="" checked="checked"></td>
     	<td></td>
	</tr>         
	<?
