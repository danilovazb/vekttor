...
<table cellpadding="0" cellspacing="0" width="100%" id="tabela_dados">
    <tbody>
            ...
            <tr id="<?=$r->id?>">
               <td width="40"><?=$r->id?></td>
               <td width="250" id="descricao">1&ordm; Avaliação de Português</td>
            ...
            <tr id="<?=$r->id?>">
               <td width="40"><?=$r->id?></td>
               <td width="250" id="descricao">2&ordm; Avaliação de Português</td>
               <td width="70"><?=dataUsaToBr($r->data)?></td>
               <td width="80"><input type="hidden" name="statusAvaliacao" id="statusAvaliacao" value="<?=$r->status;?>">
                  <a href="#" id="clickAvaliacao"> <? if($r->status == 0){ echo "Lancar";} else{ echo "Lan&ccedil;ado";}?></a>
               </td>
            ...
            <tr id="<?=$r->id?>">
               <td width="40"><?=$r->id?></td>
               <td width="250" id="descricao">3&ordm; Avaliação de Português</td>
               <td width="70"><?=dataUsaToBr($r->data)?></td>
               <td width="80"><input type="hidden" name="statusAvaliacao" id="statusAvaliacao" value="<?=$r->status;?>">
                  <a href="#" id="clickAvaliacao"> <? if($r->status == 0){ echo "Lancar";} else{ echo "Lan&ccedil;ado";}?></a>
               </td>
