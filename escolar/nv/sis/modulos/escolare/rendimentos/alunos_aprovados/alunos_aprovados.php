...
<div id="conteudo">
  ...
  //  pr($_POST);
    ...
    <div id="navegacao">
        ...
        <a href="?tela_id=<?=$_GET[tela_id]?>" class="navegacao_ativo"><span></span>Alunos Reprovados</a>
    </div>
...
<div id="dados">
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tbody>
                <tr class="al">
                    <td  width="50">0021</td>
                    <td width="200">Gilvandro de Souza Silva</td>
                    <td width="200">Escola  Municipal Beatriz Maranhão</td>
                    <td width="150">1º ano do 1º ciclo</td>
                    <td width="80">9.50</td>
                    <td width="50">Nota</td>
                    <td width=""></td>
                </tr>
                <tr>
                    <td  width="50">0212</td>
                    <td width="200">Bruna Melo Góes</td>
                    <td width="200">Escola Municipal Brasil de Todos</td>
                    <td width="150">1º ano do 2º ciclo</td>
                    <td width="80">9.30</td>
                    <td width="50">Falta</td>
                    <td width=""></td>
                </tr>
                <tr>
                <tr class="al">
                    <td  width="50">0311</td>
                    <td width="200">Yuri Garcia Cardoso</td>
                    <td width="200">Escola Municipal Beatriz Maranhão</td>
                    <td width="150">2º ano do 2º ciclo</td>
                    <td width="80">9.50</td>
                    <td width="50">Nota</td>
                    <td width=""></td>
                </tr>
                <tr>
                    <td  width="50">0055</td>
                    <td width="200">Jordana Vieira Carneiro</td>
                    <td width="200">Escola Municipal Claudemir Carvalho</td>
                    <td width="150">3º ano do 1º ciclo</td>
                    <td width="80">9.30</td>
                    <td width="50">Nota</td>
                    <td width=""></td>
                </tr>
