...
<div id="conteudo">
  ...
  //  pr($_POST);
    ...
    <div id="navegacao">
        ...
        <a href="?tela_id=<?=$_GET[tela_id]?>" class="navegacao_ativo"><span></span>Melhores Turmas</a>
    </div>
...
-->
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <thead>
            <tr>
                <td width="50">Cod.</td>
                <td width="150">Turma</td>
                <td width="150">Esnino</td>
...
<div id="dados">
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            <tbody>
                <tr class="al">
                    <td  width="50">0021</td>
                    <td width="150">Turma A</td>
                    <td width="150">1º ano do 1º cilco</td>
                    <td width="200">Escola Municipal Batriz Maranhão</td>
                    <td width="80">5</td>
                    <td width="80">9.50</td>
                    <td width=""></td>
                </tr>
                <tr class="">
                    <td  width="50">0351</td>
                    <td width="150">Turma B</td>
                    <td width="150">1º ano do 2º cilco</td>
                    <td width="200">Escola Muncipal Charles Garcia</td>
                    <td width="80">5</td>
                    <td width="80">9.50</td>
                    <td width=""></td>
                </tr>
