...
<div id="conteudo">
    ...
    <div id="navegacao">
        ...
        <a href="?tela_id=217" class="navegacao_ativo"><span></span>Confirmção Matrículas</a>
    </div>
...
<div id="dados">
	...
	?>
        <table cellpadding="0" cellspacing="0" width="100%" id="lista">
           ...
           <tr onclick="window.open('modulos/escolare/matricula_confirmacao/form.php','carregador')">
            <td>R</td>
            <td onclick="o(815)">00815</td>
            <td onclick="l(Gilvandro de Souza Silva)">Gilvandro de Souza Silva</td>
