...
<div>
	...
	<form class="form_float" method="post" onsubmit="document.getElementById('tipo_cadastro').value=document.getElementById('seleciona_tipo_cadastro').value;return validaForm(this);" enctype="multipart/form-data" id='form_matricula' autocomplete='off'>
	  <fieldset id="campos_1" >
       	  <legend>
          <strong>Confirmação de Matricula</strong> 
          </legend>
...
<div style="clear:both"></div>			<label style="width:120px;">
  ...
  <div id='pagina_id_2' class='paginamatricula axluml' style="width:770px;  display:none">
            ...
            <label style="width:120px;">
				Data de Nascimento
				<input type="text" onkeyup="verifica_idade(this)" valida_idade='0,99' id="data_nascimento" name="data_nascimento[]" mascara="__/__/____" sonumero="1" value="26/07/2008" retorno='focus|Preencha o Aniversário do aluno' valida_data='01/01/0001,99/99/9999' />
			</label>
            ...
            <label style="width:120px;">
				RG
				<input type="text" id="rg" name="rg[]" sonumero='1' value="12344-54" />
			</label>
            
            <label style="width:120px;">
				Data Expedição
				<input type="text" id="rg_dt_expedicao" name="rg_dt_expedicao[]" mascara='__/__/____' value="12/11/2003" />
			</label>
            ...
            <label style="width:202px;">
				E-Mail
				<input type="text" id="email" name="email[]" retorno='focus|Coloque o email corretamente' value="gilvandro@vekttor.com" />
			</label>
            <label style="width:120px;">
				Telefone Residencial
				<input type="text" id="telefone1" name="telefone1[]" mascara='(__)____-____' value="(92)3533-4203" />
			</label>
            
            <label style="width:120px;">
				Telefone Celular
				<input type="text" id="telefone2" name="telefone2[]" mascara='(__)____-____' value="(92)9202-2909" />
			</label>
            <label style="width:320px;">
				Endereço
				<input type="text" id="endereco" name="endereco[]" value="Rua: 15 de outubro  2037" />
			</label>
            
            <label style="width:120px;">
				Bairro
				<input type="text" id="bairro" name="bairro[]" value="Palmares" />
			</label>
            ...
            <label style="width:100px;">
				CEP
				<input type="text" id="cep" name="cep[]" mascara='__.___-___' sonumero='1' value="69153-160"  />
			</label>
			
            <label style="width:150px;">
				Cidade
				<input type="text" id="cidade" name="cidade[]" value="Manacapuru" />
			</label>
            
            <label style="width:50px;">
				UF
				<input type="text" id="uf" name="uf[]" value="Am" />
			</label>
            
             <label style="width:200px;">
				Portador de Necessidades Especiais
				<input type="text" id="uf" name="uf[]" value="Surdo" />
			</label>
            <div style="clear:both"></div>
...
?>
	...
	?>
        ...
        <input type="submit" name="Confirmar"  pagina='1' value="Confirmar" style="float:right; display:none "  class="salvar"  />
