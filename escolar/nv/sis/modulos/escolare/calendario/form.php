...
<div>
	...
	<fieldset  id='campos_1' >
		...
		<label style="width:262px;">Cliente
        	<input type="text" name="nome_cliente" id="cliente" value="<?php echo $cliente->nome_fantasia;?>" busca="modulos/agendamento/agenda_diaria/busca_cliente.php,@r1,@r1-value>nome_cliente|@r0-value>cliente_id,0">
        </label>
        ...
        <label style="width:100%;">Agenda
        	...
        	<!--input type="text" name="agenda_id" id="agenda_id">-->
        </label>
