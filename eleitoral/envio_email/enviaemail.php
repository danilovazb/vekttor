...
//foreach($emails as $email){
	...
	envia_email('dernandonc@hotmail.com',"Teste Hotmail PHP Mailer","Teste de Hotmail Usando PHP Mailer","deputado@josueneto.com");
	//envia_email('marionovo@live.com',"Teste Hotmail PHP Mailer","Teste de Hotmail Usando PHP Mailer","deputado@josueneto.com");
	//envia_email('cvsb8675@hotmail.com',"Teste Hotmail PHP Mailer","Teste de Hotmail Usando PHP Mailer","deputado@josueneto.com");
	//envia_email('cvsb8675@outlook.com',"Teste Hotmail PHP Mailer","Teste de Hotmail Usando PHP Mailer","deputado@josueneto.com");
//}
