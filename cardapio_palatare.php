...
<table width="1200" cellpadding="0" cellspacing="0" class='linha' id='linha'>
<tr>
	<td colspan="3" align="center">
     &nbsp;
	<?php
		if(file_exists("sis/modulos/vekttor/clientes/img/".$vkt_id.".png")){
		echo "<img src='sis/modulos/vekttor/clientes/img/".$vkt_id.".png' height='70'/>";
	}
	?>
    </td>
    <td colspan="3">
  ...
  <H1 style="margin:0; text-align:center; "> Cardápio</H1>
  </div>
  <div style="float:right;margin-right:600px;">
   ...
   if(file_exists("sis/modulos/administrativo/clientes/fotos_clientes/".$contrato->cliente_id.".png")){
    	//echo "<img src='../../vekttor/clientes/img/".$vkt_id.".png' height='70'/>";
		echo "<img src='sis/modulos/administrativo/clientes/fotos_clientes/".$contrato->cliente_id.".png'/>";
	}
	?>
    </td>
</tr>
...
?>
	...
	?>
        <td width="150" valign="top"><? echo $dia_formatado; if($i==0){echo ', '.$semana_abreviado[$dia_escrito];}?></td>
        <? } ?>
     </tr>
	<tr>
	<tr>
	...
	<tr class='dif'>
        ...
        <? for($c=0;$c<7;$c++){
			...
			$d=mysql_result(mysql_query($a="SELECT DATE_ADD(DATE_SUB('".$filtro_inicio."', INTERVAL ".($dia_da_semana-1)." DAY), INTERVAL ".(7*$i+$c)." DAY)"),0,0);
		?>
        <td width="150" valign="top"><?  exibe_fichas($contrato_id,'almoco',$d,$filtro_inicio,$filtro_fim,$vkt_id) ?></td>
        <? } ?>
     </tr>
	<tr>
